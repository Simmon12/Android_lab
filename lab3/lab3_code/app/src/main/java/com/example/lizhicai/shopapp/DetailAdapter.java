    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        switch (Name) {
            case "Enchated Forest":
                holder.pc.setImageResource(R.drawable.enchatedforest);
                break;
            case "Arla Milk":
                holder.pc.setImageResource(R.drawable.arla);
                break;
            case "Devondale Milk":
                holder.pc.setImageResource(R.drawable.devondale);
                break;
            case "Kindle Oasis":
                holder.pc.setImageResource(R.drawable.kindle);
                break;
            case "waitrose 早餐麦片":
                holder.pc.setImageResource(R.drawable.waitrose);
                break;
            case "Mcvitie's 饼干":
                holder.pc.setImageResource(R.drawable.mcvitie);
                break;
            case "Ferrero Rocher":
                holder.pc.setImageResource(R.drawable.ferrero);
                break;
            case "Maltesers":
                holder.pc.setImageResource(R.drawable.maltesers);
                break;
            case "Lindt":
